...
MODES = {
    'f': ('Forward',    [0.4, 0.4]),      # operate.py ARROW_KEY_SPEEDS[K_UP]
    'b': ('Backward',   [-0.4, -0.4]),    # operate.py ARROW_KEY_SPEEDS[K_DOWN]
    'l': ('Turn left',  [-0.35, 0.35]),   # operate.py ARROW_KEY_SPEEDS[K_LEFT]
    'r': ('Turn right', [0.35, -0.35]),   # operate.py ARROW_KEY_SPEEDS[K_RIGHT]
}

# Matches Operate.__init__'s self.pid_gains in operate.py.
PID_GAINS = {'kp': 2, 'ki': 0.04, 'kd': 0.29}
