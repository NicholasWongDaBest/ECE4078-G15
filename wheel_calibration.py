...
def calibrateScale():
    ...
    wheel_speed_range = [[0.4, 0.4], [0.4, 0.4], [0.4, 0.4],[0.4, 0.4], [0.4, 0.4], [0.4, 0.4]]
    delta_times = []
    ...
    for wheel_speed in wheel_speed_range:
        ...
        while True:
            ...
            botconnect.move_auto_time(wheel_speed, delta_time)
...
def calibrateBaseline(scale):
    ...
    wheel_speed_range = [[-0.35, 0.35], [-0.35, 0.35], [-0.35, 0.35],[-0.35, 0.35], [-0.35, 0.35]]
    delta_times = []
